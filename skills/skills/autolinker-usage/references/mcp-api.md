...
- `tools/list` 当前返回 20 个工具：18 个 AutoLinker 原生工具（其中 3 个网络工具已禁用）和 2 个网关路由工具。
...
> ⚠️ **静默 MCP 版说明**：以下网络工具已在本版本中**完全禁用**：
> - `search_web_tavily` - Tavily 联网搜索
> - `fetch_url` - HTTP 获取公开 URL
> - `extract_web_document` - 网页内容提取
